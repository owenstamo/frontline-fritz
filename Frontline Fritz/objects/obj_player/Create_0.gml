...
physics_fixture_add_point(default_fix, 55,13);
physics_fixture_add_point(default_fix, 55,70);
...
physics_fixture_add_point(crouch_fix, 55,50);
physics_fixture_add_point(crouch_fix, 55,70);
